...
enum Key
{
	...
	SPACE = VK_SPACE, TAB = VK_TAB, SHIFT = VK_SHIFT, CONTROL = VK_CONTROL, INSERT = VK_INSERT, DEL = VK_DELETE, HOME = VK_HOME, END = VK_END, PGUP = VK_PRIOR, PGDN = VK_NEXT, ALT = VK_MENU,
	...
	OEM_1 = VK_OEM_1, OEM_2 = VK_OEM_2, OEM_3 = VK_OEM_3, OEM_4 = VK_OEM_4, OEM_5 = VK_OEM_5, OEM_6 = VK_OEM_6, OEM_7 = VK_OEM_7, OEM_8 = VK_OEM_8
};
