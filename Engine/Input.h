...
enum Key
{
	...
	SPACE = VK_SPACE, TAB = VK_TAB, LSHIFT = VK_LSHIFT, RSHIFT = VK_RSHIFT, LCONTROL = VK_LCONTROL, RCONTROL = VK_RCONTROL,
	INSERT = VK_INSERT, DEL = VK_DELETE, HOME = VK_HOME, END = VK_END, PGUP = VK_PRIOR, PGDN = VK_NEXT, LALT = VK_LMENU, RALT = VK_RMENU,
